...
class KinematicObservation(ObservationType):
    ...
    def observe(self) -> np.ndarray:
        ...
        if close_vehicles:
            ...
            #     dict_ = v.to_dict(origin, observe_intentions=self.observe_intentions)
            #     # 对于背景车来说
            #     # cos_h  ---->   delta_x
            #     # sin_h  ---->   delta_y
            #     # lat_off---->   delta_vx
            #     # ang_off---->   delta_vy
            #     dict_['cos_h'] = dict_['x'] - dict['x']
            #     dict_['sin_h'] = dict_['y'] - dict['y']
            #     dict_['lat_off'] = dict_['vx'] - dict['vx']
            #     dict_['ang_off'] = dict_['vy'] - dict['vy']
